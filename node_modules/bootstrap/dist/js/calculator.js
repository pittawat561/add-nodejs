...
const opertionButton = document.querySelectorAll('[data-operation]');
...
opertionButton.forEach((button) => {
    button.addEventListener("click", () => {
        calculator.flushOpertor(button.innerText);
        calculator.updateDisplay();
    })
});
